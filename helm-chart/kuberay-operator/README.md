...
- Install a stable version via Helm repository (only supports KubeRay v0.4.0+)
  ...
  # Install both CRDs and KubeRay operator v1.5.2.
  helm install kuberay-operator kuberay/kuberay-operator --version 1.5.2
...
- Install KubeRay operator without installing CRDs
  ...
  kubectl create -k "github.com/ray-project/kuberay/ray-operator/config/crd?ref=v1.5.2&timeout=90s"

  # Step 2: Install KubeRay operator only. (for developer)
  helm install kuberay-operator kuberay/kuberay-operator --version 1.5.2 --skip-crds
  ```
...
# kuberay-operator        default         1               2023-09-22 02:57:17.306616331 +0000 UTC deployed        kuberay-operator-1.5.2
```
