...
# Step 3: Install both CRDs and KubeRay operator v1.7.0-rc.0.
helm install kuberay-operator kuberay/kuberay-operator --version 1.7.0-rc.0

# Step 4: Install a RayCluster custom resource
# (For x86_64 users)
helm install raycluster kuberay/ray-cluster --version 1.7.0-rc.0
...
helm install raycluster kuberay/ray-cluster --version 1.7.0-rc.0 --set image.tag=nightly-aarch64
